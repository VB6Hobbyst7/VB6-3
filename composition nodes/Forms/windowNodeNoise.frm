...
Begin VB.Form windowNodeNoise 
   ...
   Begin VB.TextBox boxSeed 
      ...
      Width           =   1215
   End
   Begin VB.CheckBox checkUniform 
      Caption         =   "&Uniform"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   8.25
   ...
   End
End
Attribute VB_Name = "windowNodeNoise"
...
' color mode
Public p_uniform As Long

' base
Public p_seed As Long
...
Public Sub update()
  ...
  ' color mode
  checkUniform.Value = p_uniform

  ' base
  boxSeed.Text = p_seed & vbNullString
...
Private Sub boxSeed_Change()

  If (freeze <> 0) Then Exit Sub
  p_seed = Val(boxSeed.Text)
...
Private Sub checkUniform_Click()

  If (freeze <> 0) Then Exit Sub
  p_uniform = checkUniform.Value
